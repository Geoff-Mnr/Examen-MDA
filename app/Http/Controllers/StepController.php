...
class StepController extends Controller
{
    ...
    public function step7()
    {
        ...
        return view('step7', compact('title', 'description', 'next', 'button', 'numbers', 'triNumbers'));
    }
    ...
    public function step10()
    {
        ...
        $next = "";
        $button = "";
        return view('step10', compact('title', 'description', 'next', 'button'));
    }
}
